...
public class DSLinkedList<E extends Comparable<E>> implements DSList<E> {
    ...
    public DSLinkedList<E> subList(int start, int end) throws DSListException {
        Node<E> p1 = head_ptr;
        DSLinkedList<E> sub = new DSLinkedList<E>();
     ...
     public DSLinkedList<E> subList(int start) throws DSListException {
     Node<E> p1 = head_ptr;
        DSLinkedList<E> sub = new DSLinkedList<E>();
        for(int i = 0; i < start; i++) {
            p1 = p1.next;
...
Time: O(n^2)*/
    public E getMode() throws DSListException {
        ...
        public boolean hasConsecutiveRepeathelper() throws DSListException{
            return this.hasConsecutiveRepeat();
        }
        private boolean hasConsecutiveRepeat() throws DSListException {
            if(this.size < 2) {return false;}
            Node<E> p1 = this.head_ptr;
            DSLinkedList<E> sub = this.subList(1);
            return p1.equals(p1.next) || sub.hasConsecutiveRepeat();
        }
